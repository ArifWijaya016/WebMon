    ...
    public function insertData()
      {
         ...
         if($hitung == count($arrcheckpost)){
               ...
               $result = mysqli_query($mysqli, "INSERT INTO irigasi SET
               nama = '$_POST[nama]',
 ...
 function updateData($id)
      {
         ...
         if($hitung == count($arrcheckpost)){
              ...
              $result = mysqli_query($mysqli, "UPDATE irigasi SET
               nama = '$_POST[nama]',
               sensor_kelembaban = '$_POST[sensor_kelembaban]',
               sensor_n = '$_POST[sensor_n]',
               sensor_p = '$_POST[sensor_p]',
   ...
   {
      global $mysqli;
      $query="DELETE FROM irigasi WHERE id=".$id;
