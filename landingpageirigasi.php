          ...
          <div id="hero-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active c-item">
                <img src="assets/img/irigasi/server.jpg" class=" w-100 c-img" alt="NO IMAGE FOUND!">
              </div>
              <div class="carousel-item c-item">
                <img src="assets/img/irigasi/cleint.jpg" class=" w-100 c-img" alt="NO IMAGE FOUND!">
              </div>
              <div class="carousel-item c-item">
                <img src="assets/img/irigasi/old.jpg" class=" w-100 c-img" alt="NO IMAGE FOUND!">
              </div>
            </div>
